// https://observablehq.com/@juarezmeneses/d3-com-crossfilter-dc-js-e-leaflet@354
...
d3.csv("https://gist.githubusercontent.com/emanueles/65a308ffa630689c11a031252998ef8d/raw/a004c770786229d54264406118ae21ba7e4c51a8/earthquakes.csv").then(function(data){
  ...
  let parseDate2 = d3.utcParse("%Y-%m-%dT%H:%M:%S")    
  data.forEach(function(d,i){
       d.dtg = d.origintime.substr(0,19)
       d.dtg = parseDate2(d.dtg)
...
timeDimension.group()
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","dateDimension","d3","magnitudeDimension","width","magnitudeGroup","depthDimension","depthGroup","dataset","timeGroup"], function(md,container,dc,dateDimension,d3,magnitudeDimension,width,magnitudeGroup,depthDimension,depthGroup,dataset,timeGroup)
{
...
attribution: '&copy; <a href="http://www.openstreetmap.org/">OpenStreetMap</a> contributors', maxZoom: 17 }).addTo(mapInstance)
return mapInstance
}
);
